...
fun SignUpScreen(navController: NavController,vm : LCViewModel) {
   Box(modifier = Modifier.fillMaxSize()){
       ...
       horizontalAlignment = Alignment.CenterHorizontally) {
           ...
           Image(painter =
           painterResource(id =R.drawable.livechat ), contentDescription = null , modifier = Modifier
               .width(200.dp)
               .padding(top = 16.dp)
               .padding(8.dp)
           )
           ...
           Text(text = "Already s user ? Go to Login - >", color = androidx.compose.ui.graphics.Color.Blue,
